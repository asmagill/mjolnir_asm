...
--- mjolnir._asm.data.utf8_53.codes(s) -> position, codepoint
--- Function
--- Returns values so that the construction
---     for p, c in utf8.codes(s) do body end
--- will iterate over all characters in string s, with p being the position (in bytes) and c the code point of each character. It raises an error if it meets any invalid byte sequence.

--- mjolnir._asm.data.utf8_53.codepoint(s [, i [, j]]) -> codepoint[, ...]
--- Function
--- Returns the codepoints (as integers) from all characters in s that start between byte position i and j (both included). The default for i is 1 and for j is i. It raises an error if it meets any invalid byte sequence.

--- mjolnir._asm.data.utf8_53.len(s [, i [, j]]) -> count | nil, position
--- Function
...
--- mjolnir._asm.data.utf8_53.offset(s, n [, i]) -> position
--- Function
...
--- mjolnir._asm.data.utf8_53.charpatt
--- Variable
